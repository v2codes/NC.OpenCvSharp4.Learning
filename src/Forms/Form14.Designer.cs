namespace NC.OpenCvSharp4.Learning.Forms
{
    partial class Form14
    {
        ...
        private void InitializeComponent()
        {
            ...
            // pcbImageShow
            // 
            pcbImageShow.Location = new Point(-1, 58);
            pcbImageShow.Name = "pcbImageShow";
            pcbImageShow.Size = new Size(801, 395);
            pcbImageShow.TabIndex = 0;
            pcbImageShow.TabStop = false;
            // 
            // btnRun
            // 
            btnRun.Location = new Point(-1, 1);
            btnRun.Name = "btnRun";
            btnRun.Size = new Size(801, 51);
            btnRun.TabIndex = 1;
            btnRun.Text = "打开摄像头，启动人脸识别追踪";
